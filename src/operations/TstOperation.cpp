...
#include "TstOperation.h"
#include <iostream>
#include <iomanip>


TstOperation::TstOperation(Processor* processor) : OneOperandOperation(processor) {

}

void TstOperation::execute() {
    std::cout << "TST OPERATION" << std::endl;
    decode();
